class Task < ActiveRecord::Base
  ...
  has_many :task_categories, dependent: :destroy      # task_categories.task_id is FK to task.id
  has_many :categories, through: :task_categories     # traverse m:m table to get to all the categories.
